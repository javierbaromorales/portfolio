...
export function FigmaPage() {
  ...
  return (
    ...
    >
      ...
      >
        <Frame x={131.03} y={17.18} w={192.062} h={39.819} className="max-md:pointer-events-none max-md:invisible">
          <a href="#top" className="relative block size-full" id="top">
            <img
              src="/figma/logo-name.svg"
              alt=""
              className="absolute top-0 left-[1.3px] h-[38.86px] w-[77.7px]"
            />
            <span className="absolute top-[18.49px] right-0 left-[98.49px] text-[18px] leading-[1.01]">
              JBM
            </span>
          </a>
        </Frame>

        <p className="absolute top-[36.61px] left-[861.87px] w-[111.909px] -translate-x-1/2 text-center text-[18px] leading-[1.01] uppercase max-md:pointer-events-none max-md:invisible">
          <HashLink href="/#experience" offset={0}>
            Experience
          </HashLink>
        </p>
        <p className="absolute top-[36.61px] left-[1006.63px] w-[93.579px] -translate-x-1/2 text-center text-[18px] leading-[1.01] uppercase max-md:pointer-events-none max-md:invisible">
          <HashLink href="/#workflow" offset={0}>
            WORKFLOW
          </HashLink>
        </p>
        <p className="absolute top-[36.61px] left-[1143.25px] w-[93.579px] -translate-x-1/2 text-center text-[18px] leading-[1.01] max-md:pointer-events-none max-md:invisible">
          <HashLink href="/#contact" offset={0}>
            CONTACT
          </HashLink>
        </p>
        <p className="absolute top-[39.61px] left-[1379.44px] w-[93.579px] -translate-x-full whitespace-pre-wrap text-right text-[16px] leading-[1.01] max-md:pointer-events-none max-md:invisible">
          <span className="underline decoration-solid">En </span>
          <span>{"  Es"}</span>
        </p>
        ...
        <h1
          className="absolute top-[280.12px] left-[125.74px] z-20 h-[456.1px] w-[1145.228px] text-[85px] leading-[1.01] font-normal"
        >
          Javier Baró Morales Frontend developer. I ship production interfaces —
          Angular, TypeScript, React, and the details users feel.
        </h1>
        <p className="hero-meta absolute top-[726.22px] left-[136.03px] w-[948.86px] whitespace-pre-wrap text-[16px] leading-[1.01]">
          {`9 Years      I     Frontend      I      Hollywood, FL`}
        </p>
        ...
        >
          <div className="hero-tilt relative size-full overflow-hidden will-change-transform">
            <img
        ...
        <div className="reveal absolute top-[1499.72px] left-[370.62px] h-[255.725px] w-[303.754px] whitespace-pre-wrap text-[36px]">
          <p className="mb-0">
            <span className="leading-[1.295]">Frontend </span>
            <span className="leading-[0.945]">developer </span>
          </p>
          <p className="mb-0 leading-[1.295]">Interfaces</p>
          <p className="mb-0 leading-[1.295]">Design systems</p>
          <p className="leading-[1.295]">Performance</p>
        </div>
        <p className="reveal absolute top-[1499.72px] left-[736.91px] h-[255.725px] w-[303.754px] text-[16px] leading-[1.575]">
          I build the frontend of web products — interfaces, component systems,
          and the interaction layer people actually use. Earlier roles were
          full-stack; the work I take now is Angular first, with React and
          Next.js when the product requires them, and getting the UI right in
          production.
        </p>
        ...
        >
          ...
          <p className="absolute top-[148px] left-[180px] w-[1080px] text-center text-[16px] leading-[1.575] text-white/55">
            Angular is the framework I know deepest. TypeScript, React, Next.js,
            HTML, and CSS sit with it. Accessibility and performance are part of
            the build, not a pass at the end.
          </p>
          <div className="absolute inset-x-[120px] top-[280px] flex justify-between">
            ...
            <div className="stack-col w-[200px]">
              ...
              <p className="mt-4 text-[28px] leading-[1.15]">A11y</p>
              <p className="mt-2 text-[16px] leading-[1.575] text-white/70">
                Performance
              </p>
            </div>
        ...
        <div className="reveal absolute top-[4096.51px] left-[738px] z-20 w-[170px] text-[14px] tracking-[1.82px] uppercase">
          ...
          <p className="leading-[1.295]">{education[0].detail}</p>
        </div>
        ...
        <div className="reveal absolute top-[4407.35px] left-[702px] z-20 w-[170px] -translate-x-full text-right text-[14px] tracking-[1.82px] uppercase">
          ...
          <p className="leading-[1.295]">{education[1].detail}</p>
        </div>
        ...
        <p className="reveal absolute top-[4658px] left-[720px] z-20 w-[420px] -translate-x-1/2 text-center text-[16px] leading-[1.575]">
          How I take on demanding frontend work — from the constraint to a
        ...
        <p className="absolute top-[5756.6px] left-[840.49px] w-[233.948px] text-[16px] leading-[1.575] font-light text-white">
          Frontend developer in Hollywood. I ship production interfaces —
          Angular, TypeScript, React — and the systems that keep them coherent.
        </p>
